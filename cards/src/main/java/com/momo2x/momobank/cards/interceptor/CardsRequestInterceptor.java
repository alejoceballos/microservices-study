package com.momo2x.momobank.cards.interceptor;
...
@Component
public class CardsRequestInterceptor implements HandlerInterceptor {

    private final CardsCrossCuttingConcernInfo info;

...
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_AMOUNT_USED_RANGE;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_AVAILABLE_AMOUNT_RANGE;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_LIMIT_RANGE;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_IS_INVALID;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_IS_MANDATORY;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_LENGTH_RANGE;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_MAX;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_MIN;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_NUMBER_PATTERN;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_TYPE_IS_MANDATORY;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_TYPE_LENGTH_RANGE;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_TYPE_MAX;
import static com.momo2x.momobank.accounts.constant.AccountsConstants.Loan.LOAN_TYPE_MIN;
